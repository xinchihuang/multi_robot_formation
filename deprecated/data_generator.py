...
from scripts.utils.gabreil_graph import get_gabreil_graph, get_gabreil_graph_local,global_to_local
from scripts.utils.occupancy_map_simulator import MapSimulator
...
class DataGenerator:
    def __init__(self, map_simulator=MapSimulator(),desired_distance=2,max_x=5,max_y=5,local=True, partial=True,safe_margin=0.1,sensor_angle=math.pi/2,K_f=1,K_m=0,K_omega=0,max_speed=1,max_omega=0):
        ...
        print("DataGenerator",self.__dict__)
