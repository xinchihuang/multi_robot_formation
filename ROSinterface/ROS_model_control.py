...
class ModelControl:
    def __init__(self, topic):
        ...
        self.model_path=os.path.join(os.getcwd()+"/src/multi_robot_formation/src/multi_robot_formation/saved_model/model_dummy.pth")
        self.EP_DICT={}
    ...
    def ModelControlCallback(self, data):
            ...
            model_data=self.robot.controller.decentralized_control_dummy_real(index=0, position_lists_local=position_list_local)
