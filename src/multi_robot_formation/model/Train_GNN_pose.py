...
from model.GNN_based_model import DecentralControllerPose
import os
...
class Trainer:
    def __init__(
        ...
        self.model = DecentralControllerPose(
    ...
    def train(self, data_path_root):
        ...
        while self.epoch < 2:
            ...
            for iter, batch in enumerate(tqdm(trainloader)):
                ...
                outs = self.model(position_lists_local, useless, scale)
...
if __name__ == "__main__":
    ...
    T.save("/home/xinchi/multi_robot_formation/saved_model/model_pose_local.pth")
