...
import numpy as np
import torch
from multi_robot_formation.model.GNN_based_model import (
    GnnMapBasic,
    GnnMapDecentralized,
    GnnPoseBasic,
    DummyModel,
)
from multi_robot_formation.model.vit_model import ViT
import cv2
from multi_robot_formation.utils.occupancy_map_simulator import MapSimulator
from multi_robot_formation.comm_data import ControlData
from multi_robot_formation.utils.gabreil_graph import get_gabreil_graph
class Controller:
